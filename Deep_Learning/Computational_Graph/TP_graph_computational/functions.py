...
class Div(_Function):
    ...
    def _backward(self, grad):
        ...
        self.dy = -self.x.data*grad/self.y.data**2
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class MatMul(_Function):
    ...
    def _backward(self, grad):
        ...
        # result of the chain rule on self.dx.
        #######################################################################
        self.dx = grad.dot(self.y.t().data)
        self.dy = self.x.t().data.dot(grad)
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class Exp(_Function):
    ...
    def __init__(self, x):
        ...
        # The notbook provide you the formulas for this operation.
        #######################################################################
        self.result = np.exp(np.array(x.data))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
    ...
    def _backward(self, grad):
        ...
        # result of the chain rule on self.dx.
        #######################################################################
        self.dx = grad * np.exp(np.array(self.x.data))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class Sin(_Function):
    ...
    def __init__(self, x):
        ...
        # The notbook provide you the formulas for this operation.
        #######################################################################
        self.result = np.sin(np.array(x.data))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class Cos(_Function):
    ...
    def __init__(self, x):
        ...
        # The notbook provide you the formulas for this operation.
        #######################################################################
        self.result = np.cos(np.array(x.data))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class Tan(_Function):
    ...
    def _backward(self, grad):
        ...
        # result of the chain rule on self.dx.
        #######################################################################
        tan_x = np.tan(self.x.data)
        
        self.dx = grad * (1 + tan_x**2)
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class Sigmoid(_Function):
    ...
    def _backward(self, grad):
        ...
        # result of the chain rule on self.dx.
        #######################################################################
        self.dx = grad * (1/(1 + np.exp(-self.x.data)) * (1 - 1/(1 + np.exp(-self.x.data))))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
...
class Tanh(_Function):
    ...
    def _backward(self, grad):
        ...
        # result of the chain rule on self.dx.
        #######################################################################
        self.dx = grad * (1 - np.tanh(self.x.data)**2)
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
