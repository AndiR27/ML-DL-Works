...
class Linear:
    ...
    def __init__(self, in_features, out_features, bias=True):
        ...
        k = 1 / in_features
        self.W = Variable(np.random.uniform(-np.sqrt(k), np.sqrt(k), (out_features, in_features)))
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
        ...
        if self.bias:
            ...
            # Ton't forget to wrap the data into a Variable.
            #######################################################################
            self.b = Variable(np.random.uniform(-np.sqrt(k), np.sqrt(k), (1, out_features)))
            #######################################################################
            # --------------------------- END OF YOUR CODE ------------------------
            #######################################################################
    ...
    def __call__(self, X):
        ...
        #######################################################################
        #X et W sont stockés en tant que Variable
        y = F.matmul(X, self.W.t())
        #X.data.dot(self.W.data.T)
        #######################################################################
        # --------------------------- END OF YOUR CODE ------------------------
        #######################################################################
        if self.bias:
