...
class Variable:
    ...
    def update_grad(self, grad, child, retain_graph=False):
        ...
        if self.grad is None:
            ...
            #######################################################################
            #Si nul, on prends les grads reçu
            ...
            #######################################################################
            #Si valeur précedentes n'est pas nul, on additionne les gradients
            self.grad += grad
    ...
    def backward(self, retain_graph=False):
        ...
        if self.grad_fn is not None:
            ...
            if not len(children):
                ...
                #######################################################################
                #Soit on efface les grad_fn, soit on accumule les gradients
                grad_fn.backward(self.grad, retain_graph)
                #######################################################################
                # --------------------------- END OF YOUR CODE ------------------------
                #######################################################################
                if not retain_graph:
